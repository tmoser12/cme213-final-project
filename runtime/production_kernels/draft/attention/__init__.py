"""Draft-model attention kernels."""

from runtime.production_kernels.draft.attention import ops
...
rope_kv_write_forward_dev = ops.rope_kv_write_forward_dev
fused_attn_forward = ops.fused_attn_forward
decode_attn_forward = ops.decode_attn_forward
decode_attn_forward_dev = ops.decode_attn_forward_dev
small_q_attn_forward = ops.small_q_attn_forward
small_q_attn_forward_dev = ops.small_q_attn_forward_dev
