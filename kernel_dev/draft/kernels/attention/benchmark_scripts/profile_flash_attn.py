"""Profiling driver for kernel_dev/target/kernels/attention/kernel.cu :: flash_attention_kernel.
...
from kernel_dev.draft.kernels.attention.jit import load_attention_ops
