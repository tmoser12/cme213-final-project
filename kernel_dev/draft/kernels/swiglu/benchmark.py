...
Mirrors kernel_dev/target/kernels/rmsnorm/benchmark.py: builds a real HF Qwen2MLP, checks
...
SwiGLU MLP against HF eager and torch.compile, writing benchmark_report.txt.
    ...
    bash kernel_dev/target/kernels/swiglu/run_benchmark.sh             # this file
    bash kernel_dev/target/kernels/swiglu/run_benchmark.sh --profile   # + nsys/ncu capture
"""
