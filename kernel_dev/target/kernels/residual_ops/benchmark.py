...
Two ops share this dir, so this file checks and times both:
  ...
  * lm_head       -- logits = hidden @ weight^T. Oracle is nn.Linear(H, vocab,
    ...
    bash kernel_dev/target/kernels/residual_ops/run_benchmark.sh             # this file
    bash kernel_dev/target/kernels/residual_ops/run_benchmark.sh --profile   # + nsys/ncu
"""
...
from kernel_dev.target.kernels.residual_ops.wrapper import custom_ops, CustomQwenLMHead
...
def main():
    ...
    report_path = report_file(__file__, "residual_ops")
