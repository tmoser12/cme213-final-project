"""kernel_dev/target/kernels/residual_ops/jit.py
...
~/.cache/torch_extensions/.../custom_residual_ops/. Subsequent calls reuse
the cached build.

If JIT picks up a stale build after editing the .cu, nuke the cache:
    rm -rf ~/.cache/torch_extensions/*/custom_residual_ops
"""
