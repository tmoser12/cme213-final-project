...
Run on a GPU node:
    ...
    srun --partition=gpu-turing --gres=gpu:1 python -m kernel_dev.target.kernels.swiglu._correctness_check
"""
...
cfg = Qwen2Config(hidden_size=3584, intermediate_size=18944, hidden_act="silu")
